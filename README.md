...
|:---|:---:|:---:|:---:|:---:|:---|
|[The candy war](https://www.acmicpc.net/problem/9037 "백준 알고리즘")|[Swift](https://github.com/GeonHyeongKim/AlgoriGym/blob/master/Simulation/The%20candy%20war.swift)|65.104%|O(n^2 + m)|O(n)|Set을 이용해 배열의 값이 모두 같은지 확인, %를 이용한 순환배열|
